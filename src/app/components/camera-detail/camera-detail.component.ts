...
import { QuestionDialogComponent } from 'src/app/components/accessory-detail/question-dialog/question-dialog.component';
...
export class CameraDetailComponent implements OnInit {
  ...
  getItem() {
    ...
    this.camerasService.getSpecificItem(id).subscribe(data => {
      this.product = data;
  ...
  addToCart(product, orderQuantity) {
    ...
    this.camerasService.updateItem(product).subscribe();
